...
def ej1():
    ...
    imprimir_nombre('Martin', 'Villodas')
...
def ej2():
    ...
    print("El promedio de los numeros es {}".format(promedio(numeros)))


def ej3():
    # Ejercicios de listas y métodos
    numeros = [5, 4, 3, 14, 6, 12]
    ...
    print("La lista de numeros ordenadas queda\n", lista_ordenada)
